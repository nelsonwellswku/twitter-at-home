...
const signOut = (instance: IPublicClientApplication) => instance.logoutRedirect();
            ...
            <AuthenticatedTemplate>
                <div className="flex flex-row">
                    ...
                    <div>
                        ...
                        <p className="pl-3 text-xs">Not you? <LinkButton onClick={() => signOut(instance)}>Sign Out</LinkButton></p>
                    </div>
                </div>
            </AuthenticatedTemplate >
        </div>)
