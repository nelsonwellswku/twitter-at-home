...
export type AzureB2CDecodedJwt = JwtPayload & { given_name: string, family_name: string }

export const createValidator = (wellKnownEndpoint: string) => (async (jwt: string): Promise<AzureB2CDecodedJwt> => {
